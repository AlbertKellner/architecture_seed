...
namespace Repository.Migrations
{
    ...
    partial class OnCareContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataEntity.Model.TodoListEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DataEntity.TaskEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DataEntity.TaskListEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("DataEntity.Model.Relations.RelationFarmaciaMedico", b =>
                {
                    ...
                    b.HasOne("DataEntity.Model.TodoListEntity", "Medico")
                        .WithMany("Farmacias")
            ...
            modelBuilder.Entity("DataEntity.TaskEntity", b =>
                {
                    b.HasOne("DataEntity.TaskListEntity")
                        .WithMany("Tasks")
